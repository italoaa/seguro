...
** DONE Loading animations for creating, closing and opening the vault
...
** DONE Only have one button for creating closing or opening at the same time.
** DONE Save password hash on creation  
** DONE Check hashes
